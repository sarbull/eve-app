    ...
    angular
        ...
        .service('DrawService', [function() {
            ...
            self.prepareCanvas = function() {
              ...
              crayonImage.onload = function() { self.resourceLoaded(); };
              crayonImage.src = "images/crayon-outline.png";

              markerImage.onload = function() { self.resourceLoaded(); };
              markerImage.src = "images/marker-outline.png";
              
              eraserImage.onload = function() { self.resourceLoaded(); };
              eraserImage.src = "images/eraser-outline.png";
              
              crayonBackgroundImage.onload = function() { self.resourceLoaded(); };
              crayonBackgroundImage.src = "images/crayon-background.png";
              
              markerBackgroundImage.onload = function() { self.resourceLoaded(); };
              markerBackgroundImage.src = "images/marker-background.png";
              
              eraserBackgroundImage.onload = function() { self.resourceLoaded(); };
              eraserBackgroundImage.src = "images/eraser-background.png";

              crayonTextureImage.onload = function() { self.resourceLoaded(); };
              crayonTextureImage.src = "images/crayon-texture.png";
              
              outlineImage.onload = function() { self.resourceLoaded(); };
